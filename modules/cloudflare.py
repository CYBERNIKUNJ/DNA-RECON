...
def __start__():
 ...
 [!] Please Enter The Target Website Address\n""")
    ...
    site = input(Fore.RED+" ┌─["+Fore.LIGHTGREEN_EX+"DNA-recon"+Fore.BLUE+"~"+Fore.WHITE+"@HOME"+Fore.RED+"/"+Fore.CYAN+"IG"+Fore.RED+"/"+Fore.LIGHTYELLOW_EX+"Bypass-CloudFlare"+Fore.RED+"""]
 └──╼ """+Fore.WHITE+"卐 ")
    if site == "":
        try:
